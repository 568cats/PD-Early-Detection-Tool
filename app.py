...
def PDresult():
    ...
    PDpredictionAudioupdated = None
    if PDpredictionAudio is not None:
        PDpredictionAudioupdated = PDpredictionAudio[0]

    # Pass the predictions into the template
    return render_template('PDresult.html', PDprediction1 = PDprediction1, PDprediction2 = PDprediction2, PDpredictionAudio= PDpredictionAudioupdated)
...
def ADresult():
    ...
    ADprediction2updated = None
    if ADprediction2 is not None:
        ADprediction2 = ADprediction2[0]
    # Pass the predictions into the template
    return render_template('ADresult.html', ADprediction1 = ADprediction1, ADprediction2 = ADprediction2updated)
